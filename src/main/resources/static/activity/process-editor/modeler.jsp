...
var appContextRoot='${pageContext.request.contextPath}/act';
</script>
	<!-- <div class="navbar navbar-fixed-top navbar-inverse" role="navigation" id="main-header">
	    <div class="navbar-header">
            <a href="" ng-click="backToLanding()" class="navbar-brand" style="background: none; width: 300px;color: white;"
               title="{{'GENERAL.MAIN-TITLE' | translate}}">通用管理平台 - 流程编辑器</a>
        </div>
	</div> -->
