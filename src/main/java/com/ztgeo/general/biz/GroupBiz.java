...
import com.ztgeo.general.mapper.ElementMapper;
import com.ztgeo.general.mapper.GroupMapper;
...
public class GroupBiz extends BusinessBiz<GroupMapper, Group> {
    ...
    private Group getParent(Group entity){
        Group parent = this.selectById(entity.getParentId());
        if(parent==null){
            entity.setParentId("-1");
            parent = this.selectById(entity.getParentId());
        }
        return parent;
    }
}
