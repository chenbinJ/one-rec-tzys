package com.ztgeo.general.constant.chenbin;
...
public class BizOrBizExceptionConstant {
    ...
    public final static String IMMOVABLE_RIGHT_INQUIRY_CODE = "QL";             //权利标识
    public final static String IMMOVABLE_MORTGAGE_INQUIRY_CODE = "DY";          //抵押标识
    public final static String IMMOVABLE_SEQUESTRATION_INQUIRY_CODE = "CF";     //查封标识
    public final static String IMMOVABLE_OBJECTION_INQUIRY_CODE = "YY";         //异议标识
    ...
    public final static String CERTIFICATE_TYPE_OF_FC = "房产证";
    public final static String CERTIFICATE_TYPE_OF_TD = "土地证";
    ...
    public final static String POWER_LEVEL_NONE = "CanNotRead";
    ...
    public final static String INTERFACE_CODE_CAN_NOT_REPEAT = "接口标识已存在";
    ...
    public final static String HANG_UP_NOT_RIGHT = "挂起程序异常";
    public final static String FILE_GET_EXCEPTION = "附件获取异常";
    public final static String DATA_TABLE_ERROR_MSG = "程序未定义的数据表标识";
    public final static String DATA_TABLE_NOT_WRITE_MSG = "流程配置的写操作服务未具备表操作标识";
    ...
    public final static String GET_DATA_BUT_SVRDATATO_IS_NULL = "未查询到服务对应数据表";
    public final static String IMPUT_SVRDATATO_IS_NOT_MATCH = "传入的ServiceDataTo与配置不符";
    ...
    public final static String STEP_INTERFACE_POWER_OUT = "步骤接口越权操作";
    ...
    public final static String TAX_INFO_IS_EXIST = "该收件已存在契税信息，禁止重复契税信息插入";
    ...
    public final static String TASK_STATUS_EXCEPTION = "任务已提交或并非签收人操作，删除失败";
    ...
    public final static String QR_INIT_EXCEPTION = "二维码生成异常";
    public final static String NO_INFORMATION_OF_OUR_WANT = "未查询到希望删除的服务数据";
    public final static String NO_POWER_DELETE_OTHER_PERSON_INFO = "危险操作，禁止删除他人保存的信息";
    public final static String TASK_STEP_EXCEPTION = "任务未查询到对应步骤信息";
    public final static String FIND_ACT_NULL = "未查到指定流程步骤信息";
    public final static String STEP_USER_OUT_POWER = "不合法的请求，用户越权进入该步骤";
    public final static String TASK_NOT_EXIST = "查询的流程任务不存在";
    public final static String DELETE_DEFALT_REASON_BY_IMMOVABLE_TYPE_NULL = "关联的不动产类型为空，删除失败";
    public final static String DELETE_DEFALT_REASON_BY_IMMOVABLE_TYPE_NOT_CLEAR = "关联的不动产类型不合法，删除失败";
    public final static String DATA_NOT_MATCH = "待保存的数据超出数据操作的权限";
    public final static String PROCESS_INSTANCE_NOT_EXIST = "未查询到指定办件实例信息";
    public final static String PROCESS_HANDLE_SUB_NOT_ENOUGH_POWER = "您不是管理员，您无权执行该项功能，请联系管理员解决";
    public final static String EXCEPTION_RECORD_NOT_EXIST = "异常记录不存在";
    public final static String EXCEPTION_RECORD_ALREADY_DEAL = "异常情况已被处理，请勿重复处理";
    public final static String EXCEPTION_DIRECTION_NOT_CLEAR = "异常信息产生方向不明";
    public final static String EXCEPTION_DIRECTION_OUTER_NO_TASKID = "向外方向的任务不明";
    public final static String EXCEPTION_DIRECTION_NOT_RIGHT = "异常信息产生方向不合法";
    public final static String EXCEPTION_DEAL_FAILD = "步骤异常处理失败，详情查询错误日志";
    public final static String EXCEPTION_HAVING_NOT_URL = "保存的异常数据异常，缺失处理必要的URL信息";
    public final static String EXCEPTION_HAVING_NOT_NOTICE = "保存的异常数据异常，缺失处理必要的通知内容(noticeText)信息";
    public final static String PROCESS_START_POWER_OUT = "该用户无权启动该流程";
    public final static String DATA_EXCEPTION = "待保存的数据格式不正确";
    public final static String SERVICECODE_CAN_NOT_BE_NULL = "条件servicecode操作异常，使用时发现为空";
    public final static String RESPONSE_RECORD_IS_NULL = "接口响应的服务数据为空";
    public final static String POSITION_IS_NULL = "请先授权岗位";
    public final static String IMMOVABLE_RIGHT_OUT = "超出范围的不动产权利事项";
    public final static String MORTGAGE_HOLD_MAN = "解析的抵押权人为空，请排查";
    public final static String RECORD_CAN_NOT_FIND = "记录查询不到";
    public final static String RECORD_SEARCH_PARAM_EXECEPTION = "记录查询参数异常";
    public final static String RECORD_RESULT_EXECEPTION = "记录查询结果异常";
    public final static String FIND_SERVICE_NULL="未查到指定服务信息";
    public final static String QUERY_PARAM_FILE_IS_NULL = "接口执行必要的附件参数未上传";
    public final static String PDF_EXCEPTION_WITH_IO = "PDF生成过程中出现io异常，请排查";
    public final static String PDF_EXCEPTION_WITH_DOC = "PDF生成过程中出现文档操作异常，请排查";
    public final static String PDF_EXCEPTION_WITH_OTHER = "pdf文件路径更新失败，操作取消并删除pdf";
}
