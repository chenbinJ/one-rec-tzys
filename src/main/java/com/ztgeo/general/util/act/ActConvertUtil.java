 ...
 */
public class ActConvertUtil {
    //	private static Logger logger = LoggerFactory.getLogger(ActConvertUtil.class);
...
//	}
   ...
   // @SuppressWarnings({ "unused" })
    ...
    public static UserEntity toActivitiUser(User employee){
        if (employee == null){
            return null;
        }
        UserEntity userEntity = new UserEntity();
        userEntity.setId(employee.getId());
    ...
    public static GroupEntity toActivitiGroup(Group role){
        if (role == null){
            return null;
        }
        ...
        groupEntity.setType(StringUtils.EMPTY);
