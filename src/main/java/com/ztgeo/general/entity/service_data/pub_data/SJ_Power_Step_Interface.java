...
public class SJ_Power_Step_Interface implements Serializable {
    private String powerId;                 //主键
    private String powerTitle;              //权限标题
    ...
    private String setUp;               //设置自动或者手动




    private SJ_Interface interfacer;         //接口
    ...
    public String toString() {
        return "SJ_Power_Step_Interface{" +
                "powerId='" + powerId + '\'' +
